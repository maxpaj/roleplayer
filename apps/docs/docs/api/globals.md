...
[core/actor/character.ts:20](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L20)
...
[core/ruleset/ruleset.ts:21](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L21)
...
[core/inventory/item.ts:13](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/inventory/item.ts#L13)
...
[core/inventory/item.ts:24](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/inventory/item.ts#L24)
...
[core/action/action.ts:9](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/action/action.ts#L9)
...
[core/actor/character.ts:94](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L94)
...
> **getElementDamageTaken**(`element`, `damageAmount`): `number`
...
[core/actor/character.ts:114](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L114)
...
> **entities**: [`BattleActor`](globals.md#battleactor)[] = `[]`
...
• **actionDef**: [`ActionDefinition`](globals.md#actiondefinition)
...
[data/rulesets/dnd-5th.ts:87](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L87)
...
> **new GloomhavenRuleset**(): [`GloomhavenRuleset`](globals.md#gloomhavenruleset)
...
[data/rulesets/gloomhaven.ts:12](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/gloomhaven.ts#L12)
...
[data/rulesets/league-of-dungeoneers.ts:49](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/league-of-dungeoneers.ts#L49)
...
[data/rulesets/league-of-dungeoneers.ts:21](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/league-of-dungeoneers.ts#L21)
...
[`PathfinderRuleset`](globals.md#pathfinderruleset)
...
[data/rulesets/pathfinder.ts:27](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/pathfinder.ts#L27)
...
> **CharacterEventType**: \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterSpawned"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`name`: `string`;`type`: `"CharacterNameSet"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`max`: `number`;`resourceTypeId`: [`CharacterResourceDefinition`](globals.md#characterresourcedefinition)\[`"id"`\];`type`: `"CharacterResourceMaxSet"`;  } \| \{`actionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`amount`: `number`;`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`resourceTypeId`: [`CharacterResourceDefinition`](globals.md#characterresourcedefinition)\[`"id"`\];`type`: `"CharacterResourceGain"`;  } \| \{`actionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`amount`: `number`;`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`resourceTypeId`: [`CharacterResourceDefinition`](globals.md#characterresourcedefinition)\[`"id"`\];`type`: `"CharacterResourceLoss"`;  } \| \{`amount`: `number`;`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`statId`: [`CharacterStatType`](globals.md#characterstattype)\[`"id"`\];`type`: `"CharacterStatChange"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`experience`: `number`;`type`: `"CharacterExperienceChanged"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`experience`: `number`;`type`: `"CharacterExperienceSet"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterDespawn"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`targetPosition`: [`Position`](globals.md#position-1);`type`: `"CharacterMovement"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterEndRound"`;  } \| \{`actionId`: [`Id`](globals.md#id-10);`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterActionGain"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`equipmentSlotId`: [`Id`](globals.md#id-10);`type`: `"CharacterEquipmentSlotGain"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`itemId`: [`Item`](globals.md#item-1)\[`"id"`\];`type`: `"CharacterItemGain"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`equipmentSlotId`: [`Id`](globals.md#id-10);`itemId`: [`Item`](globals.md#item-1)\[`"id"`\];`type`: `"CharacterItemEquip"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`targetPosition`: [`Position`](globals.md#position-1);`type`: `"CharacterPositionSet"`;  } \| \{`actionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`statusId`: [`Id`](globals.md#id-10);`type`: `"CharacterStatusGain"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterAttackAttackerHit"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterAttackAttackerMiss"`;  } \| \{`actionDefinitionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`attackerId`: [`Actor`](globals.md#actor)\[`"id"`\];`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterAttackDefenderHit"`;  } \| \{`actionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`attackerId`: [`Actor`](globals.md#actor)\[`"id"`\];`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterAttackDefenderDodge"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterAttackDefenderParry"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterClassReset"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`classId`: [`Clazz`](globals.md#clazz)\[`"id"`\];`type`: `"CharacterClassLevelGain"`;  }

#### Source

[core/campaign/campaign-events.ts:71](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/campaign/campaign-events.ts#L71)

***

### CharacterResource

> **CharacterResource**: \{`amount`: `number`;`max`: `number`;`min`: `number`;`resourceTypeId`: [`CharacterResourceDefinition`](globals.md#characterresourcedefinition)\[`"id"`\];  }
...
> **resourceTypeId**: [`CharacterResourceDefinition`](globals.md#characterresourcedefinition)\[`"id"`\]

#### Source

[core/actor/character.ts:29](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L29)

***

### CharacterResourceDefinition

> **CharacterResourceDefinition**: \{`defaultMax`: `number`;`id`: [`Id`](globals.md#id-10);`name`: `string`;  }

#### Type declaration

##### defaultMax?

> **`optional`** **defaultMax**: `number`
...
[core/ruleset/ruleset.ts:52](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L52)

***

### CharacterResourceGeneration

> **CharacterResourceGeneration**: [`CharacterResource`](globals.md#characterresource) & \{`onEvent`: [`CampaignEventType`](globals.md#campaigneventtype);  }

#### Type declaration

##### onEvent

> **onEvent**: [`CampaignEventType`](globals.md#campaigneventtype)

#### Source

[core/actor/character.ts:36](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L36)

***

### CharacterStat

> **CharacterStat**: \{`amount`: `number`;`statId`: [`CharacterStatType`](globals.md#characterstattype)\[`"id"`\];  }
...
> **statId**: [`CharacterStatType`](globals.md#characterstattype)\[`"id"`\]

#### Source

[core/actor/character.ts:68](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L68)

***

### CharacterStatType

> **CharacterStatType**: \{`id`: [`Id`](globals.md#id-10);`name`: `string`;  }
...
[core/ruleset/ruleset.ts:58](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L58)

***

### ClassLevelProgression

> **ClassLevelProgression**: \{`actionDefinitionId`: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\];`unlockedAtLevel`: `number`;  }

#### Type declaration

##### actionDefinitionId

> **actionDefinitionId**: [`ActionDefinition`](globals.md#actiondefinition)\[`"id"`\]
...
[core/ruleset/ruleset.ts:36](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L36)

***

### Clazz

> **Clazz**: \{`id`: [`Id`](globals.md#id-10);`levelProgression`: [`ClassLevelProgression`](globals.md#classlevelprogression)[];`name`: `string`;  }
...
> **levelProgression**: [`ClassLevelProgression`](globals.md#classlevelprogression)[]
...
[core/ruleset/ruleset.ts:46](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L46)
...
[core/dice/dice.ts:8](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L8)

***

### ElementDefinition

> **ElementDefinition**: \{`id`: [`Id`](globals.md#id-10);`name`: `string`;  }
...
[core/ruleset/ruleset.ts:25](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L25)

***

### EquipmentSlotDefinition

> **EquipmentSlotDefinition**: \{`eligibleEquipmentTypes`: [`ItemEquipmentType`](globals.md#itemequipmenttype)[];`id`: [`Id`](globals.md#id-10);`name`: `string`;  }

#### Type declaration

##### eligibleEquipmentTypes

> **eligibleEquipmentTypes**: [`ItemEquipmentType`](globals.md#itemequipmenttype)[]
...
[core/inventory/item.ts:29](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/inventory/item.ts#L29)
...
[lib/generate-id.ts:2](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/lib/generate-id.ts#L2)

***

### Item

> **Item**: \{`actions`: [`ActionDefinition`](globals.md#actiondefinition)[];`description`: `string`;`id`: [`Id`](globals.md#id-10);`name`: `string`;`occupiesSlots`: [`ItemSlot`](globals.md#itemslot)[];`rarity`: [`Rarity`](globals.md#rarity);`stats`: [`CharacterStat`](globals.md#characterstat)[];`type`: [`ItemType`](globals.md#itemtype);  }
...
> **occupiesSlots**: [`ItemSlot`](globals.md#itemslot)[]

An item may occupy additional slots while equipped.

##### rarity

> **rarity**: [`Rarity`](globals.md#rarity)
...
> **type**: [`ItemType`](globals.md#itemtype)

#### Source

[core/inventory/item.ts:35](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/inventory/item.ts#L35)

***

### LevelProgression

> **LevelProgression**: \{`id`: [`Id`](globals.md#id-10);`requiredXp`: `number`;`unlocksLevel`: `number`;  }
...
[core/ruleset/ruleset.ts:30](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L30)
...
[core/actor/character.ts:23](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L23)

***

### Race

> **Race**: \{`id`: [`Id`](globals.md#id-10);`name`: `string`;  }
...
[core/ruleset/ruleset.ts:41](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/ruleset/ruleset.ts#L41)

***

### Reaction

> **Reaction**: \{`action`: [`ActionDefinition`](globals.md#actiondefinition);`eventType`: [`CampaignEventType`](globals.md#campaigneventtype)\[`"type"`\];`id`: [`Id`](globals.md#id-10);`name`: `string`;`type`: [`ReactionEventType`](globals.md#reactioneventtype);  }
...
> **eventType**: [`CampaignEventType`](globals.md#campaigneventtype)\[`"type"`\]
...
> **type**: [`ReactionEventType`](globals.md#reactioneventtype)

#### Source

[core/actor/character.ts:50](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L50)

***

### ReactionResource

> **ReactionResource**: \{`reactionId`: [`Reaction`](globals.md#reaction)\[`"id"`\];`targetId`: [`Actor`](globals.md#actor)\[`"id"`\];  }

#### Type declaration

##### reactionId

> **reactionId**: [`Reaction`](globals.md#reaction)\[`"id"`\]

##### targetId

> **targetId**: [`Actor`](globals.md#actor)\[`"id"`\]

#### Source

[core/actor/character.ts:63](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L63)
...
[core/dice/dice.ts:9](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L9)

***

### Round

> **Round**: \{`id`: [`Id`](globals.md#id-10);  }
...
[core/campaign/round.ts:3](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/campaign/round.ts#L3)

***

### SystemEventType

> **SystemEventType**: \{`type`: `"Unknown"`;  } \| \{`type`: `"CampaignStarted"`;  } \| \{`type`: `"RoundStarted"`;  } \| \{`type`: `"RoundEnded"`;  } \| \{`type`: `"BattleStarted"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`type`: `"CharacterBattleEnter"`;  } \| \{`characterId`: [`Actor`](globals.md#actor)\[`"id"`\];`order`: `number`;`type`: `"CharacterBattleCharacterOrderSet"`;  }

#### Source

[core/campaign/campaign-events.ts:55](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/campaign/campaign-events.ts#L55)

## Variables

### CampaignEventTypes

> **`const`** **CampaignEventTypes**: [`CampaignEventType`](globals.md#campaigneventtype)\[`"type"`\][]

#### Source

[core/campaign/campaign-events.ts:21](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/campaign/campaign-events.ts#L21)

***

### D10

> **`const`** **D10**: [`Dice`](globals.md#dice) = `10`

#### Source

[core/dice/dice.ts:5](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L5)

***

### D2

> **`const`** **D2**: [`Dice`](globals.md#dice) = `2`

#### Source

[core/dice/dice.ts:1](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L1)

***

### D20

> **`const`** **D20**: [`Dice`](globals.md#dice) = `20`

#### Source

[core/dice/dice.ts:6](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L6)

***

### D4

> **`const`** **D4**: [`Dice`](globals.md#dice) = `4`

#### Source

[core/dice/dice.ts:2](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L2)

***

### D6

> **`const`** **D6**: [`Dice`](globals.md#dice) = `6`

#### Source

[core/dice/dice.ts:3](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L3)

***

### D8

> **`const`** **D8**: [`Dice`](globals.md#dice) = `8`

#### Source

[core/dice/dice.ts:4](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L4)

***

### DefaultCharacterResourceTypes

> **`const`** **DefaultCharacterResourceTypes**: (\{`defaultMax`: `35`;`id`: `"00000000-0000-0000-0000-000000001000"`;`name`: `"Movement speed"`;  } \| \{`defaultMax`: `20`;`id`: `"00000000-0000-0000-0000-000000001001"`;`name`: `"Health"`;  } \| \{`defaultMax`: `1`;`id`: `"00000000-0000-0000-0000-000000001002"`;`name`: `"Primary action"`;  } \| \{`defaultMax`: `1`;`id`: `"00000000-0000-0000-0000-000000001003"`;`name`: `"Secondary action"`;  } \| \{`defaultMax`: `0`;`id`: `"00000000-0000-0000-0000-000000001004"`;`name`: `"Spell slot 1"`;  } \| \{`defaultMax`: `0`;`id`: `"00000000-0000-0000-0000-000000001005"`;`name`: `"Spell slot 2"`;  })[]

#### Source

[data/rulesets/dnd-5th.ts:147](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L147)

***

### DefaultCharacterStatTypes

> **`const`** **DefaultCharacterStatTypes**: [`CharacterStatType`](globals.md#characterstattype)[]

#### Source

[data/rulesets/dnd-5th.ts:169](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L169)

***

### DefaultClassDefinitions

> **`const`** **DefaultClassDefinitions**: [`Clazz`](globals.md#clazz)[]

#### Source

[data/rulesets/dnd-5th.ts:114](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L114)

***

### DefaultElementDefinitions

> **`const`** **DefaultElementDefinitions**: [`ElementDefinition`](globals.md#elementdefinition)[] = `[]`

#### Source

[data/rulesets/dnd-5th.ts:112](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L112)

***

### DefaultEquipmentSlotDefinitions

> **`const`** **DefaultEquipmentSlotDefinitions**: [`EquipmentSlotDefinition`](globals.md#equipmentslotdefinition)[]

#### Source

[data/rulesets/dnd-5th.ts:104](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L104)

***

### DefaultLevelProgression

> **`const`** **DefaultLevelProgression**: [`LevelProgression`](globals.md#levelprogression-1)[]

#### Source

[data/rulesets/dnd-5th.ts:96](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L96)
...
[index.ts:18](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/index.ts#L18)

## Functions

### dangerousGenerateId()

> **dangerousGenerateId**(): [`Id`](globals.md#id-10)
...
[lib/generate-id.ts:4](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/lib/generate-id.ts#L4)
...
[core/dice/dice.ts:11](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/dice/dice.ts#L11)

***

### getAbilityModifier()

> **getAbilityModifier**(`abilityScore`, `fallback`): `number`

#### Parameters

• **abilityScore**: `number`

• **fallback**: `number`= `-1000`
...
[data/rulesets/dnd-5th.ts:200](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/data/rulesets/dnd-5th.ts#L200)

***

### isCharacterEvent()

> **isCharacterEvent**(`event`): `event is Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object`

#### Parameters

• **event**: [`CampaignEvent`](globals.md#campaignevent)

#### Returns

`event is Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object | Object & Object`

#### Source

[core/actor/character.ts:73](https://github.com/maxpaj/roleplayer/blob/a58ecb2/packages/roleplayer/src/core/actor/character.ts#L73)
