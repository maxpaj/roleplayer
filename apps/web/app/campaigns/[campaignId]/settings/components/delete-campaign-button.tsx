...
export function DeleteCampaignButton({ campaignId, campaignName }: { campaignId: CampaignRecord["id"]; campaignName: CampaignRecord["name"] }) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>This is an irreversible action. Are you sure you want to permanently delete {campaignName}?</DialogDescription>
        </DialogHeader>
        <Paragraph>Type the name of the campaign below</Paragraph>
        <Input placeholder={campaignName} value={confirm} onChange={(e) => setConfirm(e.target.value)} />
        <DialogFooter>
          <Button
