...
export function DeleteWorldButton({ worldId, worldName }: { worldId: WorldRecord["id"]; worldName: WorldRecord["name"] }) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>This is an irreversible action. Are you sure you want to permanently delete {worldName}?</DialogDescription>
        </DialogHeader>
