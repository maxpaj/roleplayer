...
export function PublishWorldButton({ worldId, worldName }: { worldId: WorldRecord["id"]; worldName: WorldRecord["name"] }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Are you sure you want to share {worldName} with the public?</DialogDescription>
        </DialogHeader>
